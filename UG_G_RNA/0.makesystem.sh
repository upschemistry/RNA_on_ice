...
#gmx pdb2gmx -f G_RNA.gro -ignh
gmx pdb2gmx -f UG_G_RNA.gro -ignh
# select amber99SB_NA_desres & TIP4PD
...
#insert salt 
#gmx insert-molecules -ci newSalt.gro -nmol 1 -f Wet.gro -o System0.gro -replace SOL # don't know what that "replace" is for
gmx insert-molecules -ci newSalt.gro -nmol 1 -f Wet.gro -o System0.gro
# afterward, change Z coordinate of NA to 0
# Also, edit topol.top to include sodiums:
# NA        3
